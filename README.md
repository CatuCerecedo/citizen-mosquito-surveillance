...
Catuxa Cerecedo-Iglesias*-Centre d'Estudis Avançats de Blanes (CEAB-CSIC), Blanes, Spain (catuxa.cerecedo@ceab.csic.es).
John R.B. Palmer-Universitat Pompeu Fabra (UPF), Barcelona, Spain (john.palmer@upf.edu).
...
PREREQUISITES
- R version(4.4.2.)
- Requieres R packages: `brms`, `tidyverse`, `rstanarm`, `loo`, `cmdstanr`.
